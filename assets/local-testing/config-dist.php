...
//    'connecttimeout' => null, // Set connect timeout in seconds. Not all drivers support it.
    'readonly' => [          // Set to read-only slave details, to get safe reads
      ...
      'instance' => [        // Readonly slave connection parameters
        [
          'dbhost' => getenv('MOODLE_DATABASE_READREPLICA_HOST'),
          'dbport' => getenv('MOODLE_DATABASE_READREPLICA_PORT'),    // Defaults to master port
          'dbuser' => getenv('MOODLE_DATABASE_READREPLICA_USER'),    // Defaults to master user
          'dbpass' => getenv('MOODLE_DATABASE_READREPLICA_PASSWORD'),    // Defaults to master password
        ],
        // [...],
      ],
    /*
